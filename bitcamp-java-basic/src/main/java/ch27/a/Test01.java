  ...
  public static void main(String[] args) {
    ...
    */
    ...
    Calculator c1 = (Calculator) Proxy.newProxyInstance(
        // Calculator의 클래스파일을 로딩(하드웨어에서 클래스파일을 찾아 method area에 로딩)한 ClassLoader를 넘긴다.
        Calculator.class.getClassLoader(),
        // 인터페이스의 Type(클래스 정보, 유형 등)으로 1개의 배열을 만들어 아규먼트로 넘긴다.
        new Class[] {Calculator.class},
        // InvocationHandler 구현한 객체를 만들어 아규먼트로 넘긴다.
        new MyHandler());
