...
public class Test01_3 {
  public static void main(String[] args) {
    ...
    // Test01_1.java와 Test01_2.java에서 문자를 출력하는 방법이 다르다.
    ...
    // 1) 문자를 메모리에 출력할 수 있도록 문자 출력 스트림을 준비한다.
    try (StringWriter out = new StringWriter()){

      // 2) 문자를 스트링 버퍼에 출력한다.
      // => 오호라!!! 파일에 출력하는 것과 똑같다!
      // => 단 FileWriter와 달리 write()를 호출하면
      //    그 값은 StringWriter객체의 내부에 보관된다.
