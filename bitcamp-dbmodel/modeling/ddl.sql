...
CREATE TABLE students (
  student_id INTEGER      NOT NULL, -- 학생번호
  photo_path VARCHAR(255) NOT NULL, -- 사진
  working    INTEGER      NOT NULL  -- 재직여부
);
...
CREATE TABLE lectures (
  lecture_id INTEGER      NOT NULL, -- 강의번호
  ...
  price      INTEGER      NOT NULL, -- 강의료
  nation     INTEGER      NOT NULL, -- 정부지원여부
  woker      INTEGER      NOT NULL, -- 재직자지원여부
  manager_id INTEGER      NULL      -- 매니저번호
);
...
ALTER TABLE lectures
  MODIFY COLUMN lecture_id INTEGER NOT NULL AUTO_INCREMENT;

-- 강사
CREATE TABLE teachers (
  teacher_id INTEGER      NOT NULL, -- 강사번호
  photo_path VARCHAR(255) NOT NULL, -- 사진
  salary_hr  INTEGER      NULL,     -- 시간임금
  ncs_score  INTEGER      NULL      -- NCS점수
);
...
CREATE TABLE managers (
  manager_id INTEGER     NOT NULL, -- 매니저번호
  fax        VARCHAR(30) NULL,     -- 팩스
  tel        VARCHAR(30) NOT NULL, -- 회사전화
  dept       VARCHAR(25) NOT NULL, -- 부서
  posi       VARCHAR(25) NOT NULL  -- 직위
);
...
CREATE TABLE centers (
  center_id INTEGER      NOT NULL, -- 교육센터번호
  name      VARCHAR(25)  NOT NULL, -- 지점명
  post_no   CHAR(6)      NULL,     -- 우편번호
  bas_addr  VARCHAR(255) NULL,     -- 기본주소
  det_addr  VARCHAR(255) NOT NULL  -- 상세주소
);
...
ALTER TABLE centers
  MODIFY COLUMN center_id INTEGER NOT NULL AUTO_INCREMENT;

-- 교실
CREATE TABLE rooms (
  room_id   INTEGER     NOT NULL, -- 교실번호
  name      VARCHAR(25) NOT NULL, -- 교실명
  capa      INTEGER     NOT NULL, -- 수용가능인원
  state     INTEGER     NULL     DEFAULT 1, -- 사용여부
  center_id INTEGER     NOT NULL  -- 교육센터번호
);
...
ALTER TABLE rooms
  MODIFY COLUMN room_id INTEGER NOT NULL AUTO_INCREMENT;

-- 수강신청
CREATE TABLE add_drop (
  add_id     INTEGER  NOT NULL, -- 수강신청번호
  lecture_id INTEGER  NOT NULL, -- 강의번호
  student_id INTEGER  NOT NULL, -- 학생번호
  add_dt     DATETIME NOT NULL, -- 수강신청일
  state      INTEGER  NULL     DEFAULT 0 -- 수강신청상태
);
...
ALTER TABLE add_drop
  MODIFY COLUMN add_id INTEGER NOT NULL AUTO_INCREMENT;

-- 교실사진
CREATE TABLE room_photos (
  photo_id   INTEGER      NOT NULL, -- 교실사진번호
  photo_path VARCHAR(255) NOT NULL, -- 사진
  room_id    INTEGER      NOT NULL  -- 교실번호
);
...
CREATE TABLE subjects (
  subject_id INTEGER     NOT NULL, -- 강의과목번호
  title      VARCHAR(25) NOT NULL  -- 과목명
);
...
CREATE TABLE members (
  ...
  post_number CHAR(6)      NULL,     -- 우편번호
  bas_addr    VARCHAR(255) NULL,     -- 기본주소
  det_addr    VARCHAR(255) NULL,     -- 상세주소
  last_sg_id  INTEGER      NOT NULL, -- 최종학력번호
  last_school VARCHAR(25)  NOT NULL, -- 최종학교
  major       VARCHAR(25)  NOT NULL  -- 전공
);
...
CREATE TABLE school_grade (
  sg_id INTEGER     NOT NULL, -- 학력번호
  name  VARCHAR(25) NOT NULL  -- 학력명
);
...
ALTER TABLE school_grade
  MODIFY COLUMN sg_id INTEGER NOT NULL AUTO_INCREMENT;
