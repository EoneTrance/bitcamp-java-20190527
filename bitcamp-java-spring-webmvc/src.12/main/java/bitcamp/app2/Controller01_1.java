...
public class Controller01_1 {
  ...
  public String handler1(Model model) {
    ...
    // 웹 애플리케이션이 경로가 '/bitcamp-java-spring-webmvc 라면, JSP 경로는 다음과 같다.
  ...
  // 테스트:
  //   http://localhost:8888/bitcamp-java-spring-webmvc/app2/c01_1/h3
  @GetMapping("h3") 
  public String handler3(Map<String, Object> map) {
    ...
    // 직접 JSP를 요청하지 않고, 페이지 컨트롤러를 통해 요청 해야 한다.
    //
