...
public class App2Config implements WebMvcConfigurer {
  ...
  // @MatrixVariable 애노테이션 처리를 활성화 시킨다.
  // => 이 작업을 수행하려면 MVC 관련 설정 작업을 수행할 수 있도록
  //    WebMvcConfigurer 인터페이스를 꾸현해야 한다.
  ...
  // => WebMVC 설정을 활성화시키지 않으면 WebMvcConfigurer 구현체가 있다 하더라도 무시한다.
  ...
  public void addInterceptors(InterceptorRegistry registry) {
    ...
    //      /c04_1/a/x
    //      /c04_1/a/b/x
    // 즉, /c04_1/ 바로 밑에 있는 자원에 대해서만 인터셉터를 적용한다.
