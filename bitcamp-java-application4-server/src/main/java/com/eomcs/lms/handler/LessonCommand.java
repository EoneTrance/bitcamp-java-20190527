...
public class LessonCommand {
  ...
  @RequestMapping("/lesson/add") // 클라이언트 요청이 들어왔을 때 이 메소드를 호출하라고 표시한다.
  public void add(BufferedReader in, PrintStream out) {
    try {
      Lesson lesson = new Lesson();
      lesson.setTitle(Input.getStringValue(in, out, "제목?"));
      lesson.setContents(Input.getStringValue(in, out, "내용?"));
  ...
  @RequestMapping("/lesson/delete") // 클라이언트 요청이 들어왔을 때 이 메소드를 호출하라고 표시한다.
  ...
  @RequestMapping("/lesson/detail") // 클라이언트 요청이 들어왔을 때 이 메소드를 호출하라고 표시한다.
  ...
  @RequestMapping("/lesson/list") // 클라이언트 요청이 들어왔을 때 이 메소드를 호출하라고 표시한다.
  ...
  @RequestMapping("/lesson/update") // 클라이언트 요청이 들어왔을 때 이 메소드를 호출하라고 표시한다.
