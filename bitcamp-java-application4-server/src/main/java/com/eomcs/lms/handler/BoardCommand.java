...
public class BoardCommand {
  ...
  @RequestMapping("/board/add") // 클라이언트 요청이 들어왔을 때 이 메소드를 호출하라고 표시한다.
  ...
  @RequestMapping("/board/delete") // 클라이언트 요청이 들어왔을 때 이 메소드를 호출하라고 표시한다.
  ...
  @RequestMapping("/board/detail") // 클라이언트 요청이 들어왔을 때 이 메소드를 호출하라고 표시한다.
  ...
  @RequestMapping("/board/list") // 클라이언트 요청이 들어왔을 때 이 메소드를 호출하라고 표시한다.
  ...
  @RequestMapping("/board/udpate") // 클라이언트 요청이 들어왔을 때 이 메소드를 호출하라고 표시한다.
  public void udpate(BufferedReader in, PrintStream out) {
    try {
      int no = Input.getIntValue(in, out, "번호?");
      Board board = boardDao.findBy(no);
