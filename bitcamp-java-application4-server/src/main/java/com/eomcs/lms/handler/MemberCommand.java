...
public class MemberCommand {
  ...
  @RequestMapping("/member/add") // 클라이언트 요청이 들어왔을 때 이 메소드를 호출하라고 표시한다.
  ...
  @RequestMapping("/member/delete") // 클라이언트 요청이 들어왔을 때 이 메소드를 호출하라고 표시한다.
  ...
  @RequestMapping("/member/detail") // 클라이언트 요청이 들어왔을 때 이 메소드를 호출하라고 표시한다.
  ...
  @RequestMapping("/member/list") // 클라이언트 요청이 들어왔을 때 이 메소드를 호출하라고 표시한다.
  ...
  @RequestMapping("/member/search") // 클라이언트 요청이 들어왔을 때 이 메소드를 호출하라고 표시한다.
  ...
  @RequestMapping("/member/update") // 클라이언트 요청이 들어왔을 때 이 메소드를 호출하라고 표시한다.
