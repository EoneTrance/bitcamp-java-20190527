...
public class ApplicationContext {
  ...
  private void findCommandClass(File path, String packageName) throws Exception {
  ...
  private Object getBean(Class<?> type) {
    ...
    throw new RuntimeException("해당 타입의 Bean을 찾을 수 없습니다.");
  }
  ...
  private void createTransactionManager() throws Exception {
    ...
    PlatformTransactionManager txManager = 
        new PlatformTransactionManager((SqlSessionFactory) objPool.get("sqlSessionFactory"));
  ...
  private void createDao() throws Exception {
    ...
    MyBatisDaoFactory daoFactory =
        new MyBatisDaoFactory((SqlSessionFactory) objPool.get("sqlSessionFactory"));
    objPool.put("daoFactory", daoFactory);
