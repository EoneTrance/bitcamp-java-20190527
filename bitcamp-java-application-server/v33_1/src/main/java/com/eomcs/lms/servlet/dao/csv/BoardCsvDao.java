...
import com.eomcs.lms.servlet.dao.BoardDao;
...
implements BoardDao {
  ...
  // 수퍼 클래스에서 template method(loadData(), savaData())를 정의하고
  ...
  protected String createCSV(Board obj) {
    return String.format("%d,%s,%s,%d",
        obj.getNo(), obj.getContents(), obj.getCreatedDate(), obj.getViewCount());
  }
